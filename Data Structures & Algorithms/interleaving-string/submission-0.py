        ...
        for row in range(0, ROWS):
            for col in range(0, COLS):
                ...
                if row == 0 and col == 0:
                    continue
                if row == 0:
                    can_be_formed[row][col] = can_be_formed[row][col - 1] and s2[pos2] == s3[pos3]
                    continue
                if col == 0:
                    can_be_formed[row][col] = can_be_formed[row - 1][col] and s1[pos1] == s3[pos3]
                    continue
                
                can_be_formed[row][col] = (
                    can_be_formed[row][col - 1] and s2[pos2] == s3[pos3] or 
                    can_be_formed[row - 1][col] and s1[pos1] == s3[pos3]
                )
